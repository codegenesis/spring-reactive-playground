...
import playground.couchbase.CouchbasePersonRepository;
...
public class EtlController {
    ...
    private final Sink<String, Person> couchbaseSink;
    ...
    public EtlController(ReactiveMongoPersonRepository mongoSource,
            ...
            CouchbasePersonRepository couchbaseSink,
            ElasticsearchSink elasticsearchSink) {
        this.source = mongoSource;
        this.kafkaConnector = kafkaConnector;
        this.couchbaseSink = couchbaseSink;
        this.elasticsearchSink = elasticsearchSink;
    }

    @RequestMapping(path = "/etl/couchbase", method = RequestMethod.POST)
    public Flux<Person> etlCouchbase() {
        return etl(couchbaseSink);
    }
